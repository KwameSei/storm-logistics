      ...
      <div className={classes.container}>
        <div className={classes.shipment_form}>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <Typography>Import Duty Rate: {dutyData.importDuty}</Typography>
              <Typography>Import Duty VAT: {dutyData.vat}</Typography>
              <Typography>NHIL: {dutyData.nhil}</Typography>
              <Typography>Other Charges: {dutyData.otherDutiesAndCharges}</Typography>
              <Typography>Total Charges: {dutyData.totalDutyCost}</Typography>
            </div>
